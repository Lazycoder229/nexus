...
import { User, Mail, Phone, MapPin, Calendar, Save, Camera, Lock, Edit } from "lucide-react";
...
const FacultyProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      // TODO: Replace with actual API
      // await axios.put('/api/faculty/profile', profileData);
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      // TODO: Replace with actual API
      // await axios.put('/api/faculty/change-password', passwordData);
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-indigo-400 to-blue-500 flex items-center justify-center text-white text-4xl font-bold">
                  {profileData.firstName ? profileData.firstName[0] : 'F'}{profileData.lastName ? profileData.lastName[0] : 'U'}
                </div>
              ...
              <h2 className="mt-4 text-xl font-bold text-gray-900">
                {profileData.firstName} {profileData.middleName && `${profileData.middleName[0]}.`} {profileData.lastName}
